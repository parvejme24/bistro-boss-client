...
export default function MenuCard({ menu }) {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-no-repeat bg-center bg-cover transition-opacity duration-500 opacity-0 group-hover:opacity-100 bg-[url('https://gramentheme.com/html/fresheat/assets/img/bg/dishesThumbBG.png')]"></div>

      {/* Foreground Content */}
      <img
        src={menu.image}
        alt={menu.title}
        className="relative border border-red-300/50 shadow z-10 rounded-full w-[140px] h-[140px] mx-auto"
      />
